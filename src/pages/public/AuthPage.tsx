        ...
        <Card className="shadow-md border-slate-200/90 p-6 sm:p-8">
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            <button
              ...
              className="w-full py-2 px-3 border border-slate-200 rounded-lg text-xs font-medium text-slate-700 hover:bg-slate-50 flex items-center justify-center gap-2 transition-colors"
            >
